...
class UserManager(BaseUserManager):
    ...
    def create_user(self, username, email, password, first_name=None, last_name=None, suffix=None,
                    gender=None, birthdate=None, roles=None, address=None,
                    contactnumber=None,storepassword=None):
        ...
        user = self.model(username=username, email=self.normalize_email(email), first_name=first_name,
                          ...
                          roles=roles, address=address,contactnumber=contactnumber,storepassword=storepassword)
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    storepassword = models.CharField(max_length=255, blank=True, null=True)
