    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checkmotor', models.CharField(blank=True, max_length=200)),
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='encounter', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
